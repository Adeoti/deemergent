...
<head>
    ...
    <title>My Cumulative Report</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="gradient-header text-white px-8 py-6">
            <h1 class="text-2xl font-bold">My Cumulative Report</h1>
            <p class="text-green-100 mt-1 text-sm">Select an academic session to view your annual cumulative report
                across all three terms.</p>
        </div>

        <form action="{{ route('student.cumulative-reports.go') }}" method="GET" class="px-8 py-8 space-y-6">
            <div>
